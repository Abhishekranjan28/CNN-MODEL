...
def load_saved_artifacts():
    ...
    global __model
    if __model is None:
        with open(r'C:\Users\ASUS\Desktop\Persona classify\saved_model1.pkl', 'rb') as f:
...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    face_cascade = cv2.CascadeClassifier(r'C:\Users\ASUS\Desktop\Persona classify\haarcascade\haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier(r'C:\Users\ASUS\Desktop\Persona classify\haarcascade\haarcascade_eye.xml')
...
def get_b64_test_image_for_virat():
   ...
   # load_saved_artifacts()
    ...
    #print(classify_image(None,r'C:\Users\ASUS\Desktop\Persona classify\th_id=OIP (49).jpg'))

    # print(classify_image(None, "./test_images/federer1.jpg"))
    # print(classify_image(None, "./test_imagefederer2.jpg"))
